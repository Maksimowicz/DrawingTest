...
namespace ImageProcessingMM.EngineClasses
{
    public class HSVBit
    {
        ...
        {
            var a = 0;
            //if(this.saturation >1 || this.value >1)
            //{
            //    a = 2;
            //}
    ...
    public class HistogramData
    {
        ...
        public Dictionary<float, int> HSV_HHisto { get; set; }
        public Dictionary<float, int> HSV_SHisto { get; set; }
        public Dictionary<float, int> HSV_VHisto { get; set; }
        ...
        public HistogramData()
        {
            ...
            HSV_HHisto = new Dictionary<float, int>();
            HSV_SHisto = new Dictionary<float, int>();
            HSV_VHisto = new Dictionary<float, int>();
        }
    }
    ...
    public class DirectBitmap : IDisposable
    {
        ...
        public DirectBitmap(Bitmap bitmap)
        {
            ...
            BitmapData imageData = innerBitmap.LockBits(new Rectangle(0, 0, Width, Height), ImageLockMode.ReadWrite, PixelFormat.Format32bppPArgb);
        ...
        public HSVBit GetPixelHSV(int x, int y)
        {
            int index = x + (y * Width);
            return HSVBits[index];
        }
